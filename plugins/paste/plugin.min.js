! function (e, t) {
    ...
    r(l, [c, d, u], function (e, t, n) {
                    ...
                    i.on("keydown", function (e) {
                        if (a(e) && !e.isDefaultPrevented()) {
                            ...
                            g = o(), i.dom.bind(t, "paste", function () {
                                setTimeout(function () {
                                    i.selection.setRng(n), p(t), l() ? u(s(t.firstChild)) : d(t.firstChild.innerHTML)
                                }, 0)
                            });
                        ...
                        i.dom.bind(i.getBody(), "paste", function (t) {
                            if (o() - g > 100) {
                                ...
                                i.selection.setRng(a), l() ? u(s(r.firstChild)) : d(r.firstChild.innerHTML)
                            }
                        })
                    })
            ...
            o.on("PastePreProcess", function (s) {
                ...
                function c(e) {
                    function t(e, t, a, s) {
                        ...
                        var c = t.next;
                        c && 3 == c.type && (c.value = c.value.replace(/^\u00a0+/, "")), l > o && r.lastChild.append(n), o = l
                    }
                ...
                if (f = o.settings.paste_retain_style_properties, f && (p = e.makeMap(f)), o.settings.paste_enable_default_filters !== !1 && /class="?Mso|style="[^"]*\bmso-|style='[^'']*\bmso-|w:WordDocument/i.test(s.content)) {
                    ...
                    h.addAttributeFilter("style", function (e) {
                        for (var t = e.length, n; t--;) n = e[t], n.attr("style", d(n, n.attr("style"))), "span" != n.name || n.attributes.length || n.unwrap()
                    });
                    var g = h.parse(u);
        ...
        e.add("paste", function (e) {
            var o = this,
                a;
            o.clipboard = a = new t(e), o.quirks = new r(e), o.wordFilter = new n(e), e.settings.paste_as_text && (o.clipboard.pasteFormat = "text"), e.addCommand("mceInsertClipboardContent", function (e, t) {
                ...
                onclick: function () {
                    "text" == a.pasteFormat ? (this.active(!1), a.pasteFormat = "html") : (a.pasteFormat = "text", this.active(!0), i || (e.windowManager.alert("Paste is now in plain text mode. Contents will now be pasted as plain text until you toggle this option off."), i = !0))
                }
            })
        })
    }), a([l, f, v, y])
